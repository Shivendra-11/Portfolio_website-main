...
const ContactPage = () => {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Contact | Shivendra Keshari</title>
        <meta name="description" content="Get in touch with Shivendra Keshari. Open to internships, full-time roles, and freelance opportunities." />
      </Helmet>
              ...
              >
                <div className="glass-card p-6 rounded-xl border-l-4 border-l-primary">
                  ...
                  <div className="space-y-5">
                    <a href="mailto:shivendrakeshari11@gmail.com" className="flex items-start gap-4 group">
                    ...
                    <a href="tel:+916391048681" className="flex items-start gap-4 group">
                      <div className="p-3 rounded-lg bg-primary/10 border border-primary/30 group-hover:bg-primary/20 transition-colors">
