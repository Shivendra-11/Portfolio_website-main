...
const SkillsPage = () => {
  ...
  return (
    <PageTransition>
      <Helmet>
        <title>Skills | Shivendra Keshari</title>
        <meta
          name="description"
          content="Technical skills of Shivendra Keshari - Java, JavaScript, React, Redux, Node.js, Express.js, MongoDB, SQL, Redis, and modern web tooling."
        />
      </Helmet>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                A toolkit built through internships, projects, and continuous learning.
              </p>
            </motion.div>
            ...
            >
              <div className="grid gap-6">
                {skillCategories[activeCategory].skills.map((skill: SkillItem, index: number) => (
                  <motion.div
                    key={skill.name}
            ...
            <motion.div
              ...
              className="mt-16"
            >
              <h2 className="text-xl font-bold font-display text-center mb-8">ALL TECHNOLOGIES</h2>
